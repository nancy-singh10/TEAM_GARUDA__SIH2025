...
export default function CampusVisualizer({ buildings, setBuildings, totalAvailablePower, isFullScreen, onToggleFullScreen, onSave }: VisualizerProps) {
  ...
  return (
    <div className="h-full w-full bg-[#0f1115] relative flex flex-col overflow-hidden select-none group/panel">
      ...
      {isModalOpen && (
          <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
              <motion.div 
                ...
                className="w-full max-w-sm bg-[#18181b] border border-gray-700 rounded-2xl shadow-2xl p-6"
              >
      ...
      {/* --- TOOLBAR --- */}
      <div className="h-24 bg-[#18181b] border-t border-gray-800 flex items-center justify-center gap-6 px-4 z-10 shadow-xl">
