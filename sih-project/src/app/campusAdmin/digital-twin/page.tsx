...
//     if (isAutoPilot) interval = setInterval(handleAdvanceTime, 2000); // 1.5s per hour
//     return () => clearInterval(interval);
//   }, [isAutoPilot, time]);

//   // --- CALCULATE ENERGY MIX ---
//   // Needed for visualizer to show gradient colors
//   // Calculate shares based on current output vs usage
//   const solarShare = capacities.solar > 0 ? solar / (solar + wind + batteryPower + 1) : 0; // Just rough estimate for now or specific logic?
...
//   return {
//     mounted, time, solar, wind, battery, batteryPower, isAutoPilot, isSaving,
//     season, selectedDate, setSelectedDate,
//     setSolar, setWind, setIsAutoPilot, handleAdvanceTime, saveDataToBackend,
//     buildings: processedBuildings, setBuildings: handleSetBuildings, totalLoad, saveBuildingsToDB,
//     capacities,
//     energyMix // E X P O R T E D
//   };
// };
...
//         {/* Date & Season Picker (Replaces Weather Buttons) */}
//         <div className="p-4 bg-white/60 dark:bg-black/20 border border-white/40 rounded-xl backdrop-blur-sm shadow-sm">
//           <label className="text-[10px] uppercase font-bold text-slate-500 mb-1 block">Simulation Starting Date</label>
//           <input
//             type="date"
//             value={selectedDate.toISOString().split('T')[0]}
//             onChange={(e) => setSelectedDate(new Date(e.target.value))}
//             className="w-full p-2 rounded border border-slate-300 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50 font-mono text-sm mb-3"
//           />
//           <div className="flex items-center justify-between">
//             <span className="text-xs font-bold text-slate-600 dark:text-slate-300">Season Detected:</span>
//             <span className={cn(
